        ...
        <div className="grid md:grid-cols-2 gap-12">
          {disciplines.map((item) => (
            <motion.div
              ...
              className="relative bg-white border-2 border-dashed border-sky-200 rounded-3xl p-8 shadow-md hover:shadow-xl transition-all cursor-pointer group"
            >
              {/* Notebook border effect */}
              <div className="absolute top-0 left-0 w-3 h-full bg-gradient-to-b from-sky-700 to-sky-950 rounded-l-3xl"></div>
              ...
              {/* Title & Desc */}
              <h4 className="text-2xl font-bold text-center text-sky-950">
                {item.title}
              </h4>

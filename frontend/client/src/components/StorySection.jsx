      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-gray-700 mt-4 text-lg md:text-xl max-w-3xl mx-auto">
            A test of <span className="font-bold text-sky-950">mental agility</span>, focus, and recall. 
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-sky-950 mb-4">Global Participation</h3>
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-sky-950 mb-4">Legacy & Impact</h3>
            <p className="text-gray-700 leading-relaxed">

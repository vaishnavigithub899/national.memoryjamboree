...
export const Achievements = () => {
  const upcomingSchools = [
    ...
    { name: "Maxfort School, Rohini, Delhi", logo: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQtcl1XPKv1Coymmia9WWGh327VFsUx1ykY7A&s",
       images: [
        "./img/MAXFORT/img1.JPG",
        "./img/MAXFORT/img2.JPG",
        "./img/MAXFORT/img3.JPG",
        "./img/MAXFORT/img4.JPG",
        "./img/MAXFORT/img5.JPG",
        "./img/MAXFORT/img6.JPG",
        "./img/MAXFORT/img7.JPG",
        "./img/MAXFORT/img8.JPG",
        "./img/MAXFORT/img9.JPG",
        "./img/MAXFORT/img10.JPG",
        "./img/MAXFORT/img11.JPG",
       ] },

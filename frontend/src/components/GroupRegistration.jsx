      ...
      <div className="max-w-4xl mx-auto shadow-xl rounded-2xl bg-white overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-sky-600 to-green-500 text-white py-8 px-6 text-center">
          ...
          <p className="text-sm opacity-90 mt-2">
            Kindly fill the form carefully. Once submitted, changes cannot be made.
          </p>
        </div>

        {/* Instructions Section */}
        <div className="px-8 py-6 bg-yellow-50 border-b border-gray-200">
          <ul className="list-disc pl-6 space-y-2 text-gray-700 text-sm">
            <li>Group of 3 people can fill this form. Kindly provide the details accordingly.</li>
            <li>Please fill group participants details carefully to complete your Memory jamboree nation edition registration.</li>
            <li>Kindly check to make any changes once the form has been submitted.</li>
          </ul>
        </div>
        ...
        >
          ...
          <div className="col-span-2 bg-green-50 p-4 rounded-xl border border-green-200">
            ...
            <ul className="list-disc pl-6 text-sm text-gray-700 space-y-1">
              ...
              <li>Whiteforest Academy reserves the right to revise terms anytime.</li>
            </ul>
          </div>
